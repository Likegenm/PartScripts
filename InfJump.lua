...
TitleLabel.Text = "InfJump Control"
...
local function makeJump()
    ...
    if currentTime - lastJumpTime >= jumpCooldown and Character and Character:FindFirstChild("HumanoidRootPart") then
...
-- Отдельное подключение для клавиши Z (включение/выключение)
...
print("Likegenm scripts InfJump")
